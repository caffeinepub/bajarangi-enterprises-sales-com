...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: number, arg2: string, arg3: string, arg4: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async getAllAIPromptEntries(): Promise<Array<AIPromptEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAIPromptEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveAIPromptEntry(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAIPromptEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBusinessInfo(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<BusinessInfo> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: number, arg3: string, arg4: string, arg5: string): Promise<Product> {
        if (this.processError) {
            try {
